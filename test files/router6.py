...
import os.path                      # these two lines are for the 7 router setup in assignment.pdf
CONFIG_FILENAME = "config" + str(os.path.basename(__file__)[-4]) + ".txt"
...
def readConfigFile(routerId, inputPorts, routingTable, neighbourPorts):
    ...
    timer = 30
    filename = CONFIG_FILENAME        # for testing
